    ...
    <div class="row">
        <div class="col-lg-5">
            ...
            echo \russ666\widgets\Countdown::widget([
                ...
                //'format' => '%D:%H:%M:%S',
                'events' => [
                    'finish' => 'function(){  alert("Only 5 min left"); }',
                ],
            ]);
            echo "<br>";
             echo \russ666\widgets\Countdown::widget([
            ...
            //$diff = date("Y-m-d H:i", strtotime("-5 minutes", strtotime($diff)));
...
<?php
                ...
                if($maindata[$i]['image']!= "no image") {
                    ...
                    echo '<img src="'.\Yii::$app->request->BaseUrl.'/'.$maindata[$i]['image'].'" width="480px">&nbsp; &nbsp; &nbsp; ';
                ...
                if($maindata[$i][$a]!=NULL){
                  ...
                  if($o1) {
                    $model->{$a} = true;
                      echo "<div class=\"boxed\"style= background-color:#f2f2f2;' >";
