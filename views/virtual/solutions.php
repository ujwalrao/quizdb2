    ...
    <div class="row">
        <div class="col-lg-5">
            ...
            foreach($maindata as $value) {
                ...
                $default=  Questions::find()->where(['quizid'=> $maindata[$i]['quizid'],'questionid'=>$maindata[$i]['questionid']])->one();
                //print_r($default);
                //exit();
                ...
                $o1 = ($default!=NULL&&$default['weight1']>=1) ? 1 : 0;
                $o2 = ($default!=NULL&&$default['weight2']>=1) ? 1 : 0;
                $o3 = ($default!=NULL&&$default['weight3']>=1) ? 1 : 0;
                $o4 = ($default!=NULL&&$default['weight4']>=1) ? 1 : 0;
                $o5 = ($default!=NULL&&$default['weight5']>=1) ? 1 : 0;
                ?>
                <?php //echo (string)($i+1).')'; ?>
